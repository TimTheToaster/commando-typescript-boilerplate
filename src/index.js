...
client.once("ready", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        inviteUrl = "https://discordapp.com/oauth2/authorize?client_id=" + client.user.id + "&scope=bot";
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, client.login(credentials_1["default"].discordToken)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
